...
export SCRATCH_DIR=/scratch/local/project/data           # Replace with actual scratch directory for data
export SCRATCH_REP_DIR=/scratch/local/project/rep        # Replace with actual scratch directory for representations
...
# Start training
accelerate launch rep-ldm.py --config="configs/imagenet-100/dino.yaml"  # Adjust config path as needed
